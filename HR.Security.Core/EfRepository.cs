...
namespace HR.Security.Core
{
    public partial class EfRepository<T> : IRepository<T> where T : EntityBase
    {
        ...
        /// <returns></returns>
        public List<T> IncludeToList(System.Linq.Expressions.Expression<Func<T, bool>> predicate, params System.Linq.Expressions.Expression<Func<T, object>>[] paths)
        {
            IQueryable<T> query = this.Entities;
        ...
        /// <summary>
        /// Get entities by predicate and include relative paths async.
        /// </summary>
        /// <param name="predicate"></param>
        /// <param name="paths"></param>
        /// <returns></returns>
